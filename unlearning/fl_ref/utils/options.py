...
def args_parser():
    ...
    parser.add_argument('--bias', type=float, default=0.8, help="non iid setting")
    ...
    parser.add_argument('--compression_type', type=str, default='GenNorm', help="compression type")  #no_compression
    parser.add_argument('--sp_perc', type=int, default=20, help="sparsification percentage")
